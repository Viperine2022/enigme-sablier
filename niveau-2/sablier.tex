...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} sablier}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{}
\fl{ {\EXTENDS} Naturals ,\, Sequences ,\, FiniteSets}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{}
\fl{ {\CONSTANT} TailleSablier1}
\fl{ {\ASSUME} TailleSablier1 \.{\in} Nat \.{\land} TailleSablier1 \.{>} 0}
\fl{}
\fl{ {\CONSTANT} TailleSablier2}
\fl{ {\ASSUME} TailleSablier2 \.{\in} Nat \.{\land} TailleSablier2 \.{>} 0}
\fl{}
\fl{ {\CONSTANT} NbSabliers}
\fl{ {\ASSUME} NbSabliers \.{\in} Nat \.{\land} NbSabliers \.{>} 0}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{ {\VARIABLES}}
\fl{ sableHaut ,\,}\al{21}{2}{%
\@y{\@s{0}%
 la quantité de sable restante des sabliers
}%
}
\fl{ sableBas ,\,%
\@y{\@s{0}%
 la quantité de sable écoulée des sabliers
}%
}
\fl{ temps}\al{23}{1}{%
\@y{\@s{0}%
 le \ensuremath{temps} mesuré
}%
}
\fl{}
\fl{ EnsembleSabliers \.{\defeq} 0 \.{\dotdot} NbSabliers \.{-} 1}
\fl{}
\fl{ tempsPetit \.{\defeq}}
\fl{ \.{\land} temps \.{\leq} 100}
\fl{}
\fl{ ToujoursOk \.{\defeq} {\Box} tempsPetit}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
\fl{ inv ( i ) \.{\defeq} {\IF} i \.{=} 0 \.{\THEN} 1 \.{\ELSE} 0}
\fl{}
 \fl{ tailleSab ( i ) \.{\defeq} {\IF} i \.{=} 0 \.{\THEN} TailleSablier1
 \.{\ELSE} TailleSablier2}
\fl{}
 \fl{ soustraire\_sable ( indice ,\, valeur ) \.{\defeq} {\IF} sableHaut [
 indice ] \.{\leq} valeur \.{\THEN} 0 \.{\ELSE} sableHaut [ indice ] \.{-}
 valeur}
\fl{}
 \fl{ ajouter\_sable ( indice ,\, valeur ) \.{\defeq} {\IF} sableBas [ indice
 ] \.{+} valeur \.{\geq} tailleSab ( indice ) \.{\THEN} tailleSab ( indice )
 \.{\ELSE} sableBas [ indice ] \.{+} valeur}
\fl{}
\fl{}
\fl{ Init \.{\defeq}}
 \fl{ \.{\land}}\al{54}{1}{ sableHaut \.{=} [ i \.{\in} EnsembleSabliers
 \.{\mapsto} tailleSab ( i ) ]}
 \fl{ \.{\land}}\al{55}{1}{ sableBas \.{=} [ i \.{\in} EnsembleSabliers
 \.{\mapsto} 0 ]}
\fl{ \.{\land}}\al{56}{1}{ temps \.{=} 0}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ ecouler}\al{61}{1}{ ( i ) \.{\defeq}}
\fl{ \.{\land}}\al{62}{1}{ sableHaut [ i ] \.{>} 0}
 \fl{ \.{\land}}\al{63}{1}{ sableHaut \.{'} \.{=} [ sableHaut {\EXCEPT}
 {\bang} [ i ] \.{=} 0 ,\, {\bang} [ inv ( i ) ] \.{=} soustraire\_sable (
 inv ( i ) ,\, sableHaut [ i ] ) ]}
 \fl{ \.{\land}}\al{64}{1}{ sableBas \.{'} \.{=} [ sableBas {\EXCEPT} {\bang}
 [ i ] \.{=} tailleSab ( i ) ,\, {\bang} [ inv ( i ) ] \.{=} ajouter\_sable (
 inv ( i ) ,\, sableHaut [ i ] ) ]}
\fl{ \.{\land}}\al{65}{1}{ temps \.{'} \.{=} temps \.{+} sableHaut [ i ]}
\fl{}
\fl{}
\fl{}
\fl{ retourner ( i ) \.{\defeq}}
 \fl{ \.{\land}}\al{70}{1}{ sableHaut \.{'} \.{=} [ sableHaut {\EXCEPT}
 {\bang} [ i ] \.{=} sableBas [ i ] ]}
 \fl{ \.{\land}}\al{71}{1}{ sableBas \.{'} \.{=} [ sableBas {\EXCEPT} {\bang}
 [ i ] \.{=} sableHaut [ i ] ]}
\fl{ \.{\land}}\al{72}{1}{ {\UNCHANGED} {\langle} temps {\rangle}}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{ Next \.{\defeq}}
\fl{ \E\,}\al{80}{1}{ i \.{\in} EnsembleSabliers \.{:}}
\fl{ \.{\lor}}\al{81}{1}{ ecouler ( i )}
\fl{ \.{\lor}}\al{82}{1}{ retourner ( i )}
\fl{}
\fl{}
\fl{}
 \fl{ Spec \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ {\langle} sableHaut ,\,
 temps {\rangle}}}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
